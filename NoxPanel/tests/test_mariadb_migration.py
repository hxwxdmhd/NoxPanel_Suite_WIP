...
class TestDatabaseFactory(unittest.TestCase):
    ...
    def test_create_sqlite_database(self):
        ...
        config = {"type": "sqlite", "path": ":memory:", "pool_size": 5}
...
class TestMigrationIntegration(unittest.TestCase):
    ...
    def _create_test_data(self):
        ...
        # Create test users
        user1_id = self.db_service.users.create_user(
            "testuser1", "password123", "user1@test.com", "user"
        )
        user2_id = self.db_service.users.create_user(
            "testuser2", "password456", "user2@test.com", "admin"
        )
...
class TestMigrationCLI(unittest.TestCase):
    ...
    def test_migration_configuration_parsing(self):
        ...
        config = {
            "source": {"type": "sqlite", "path": "/path/to/source.db"},
            "target": {
                "type": "mariadb",
                "host": "localhost",
                "port": 3306,
            ...
            "migration": {"batch_size": 1000, "validate": True},
        }
